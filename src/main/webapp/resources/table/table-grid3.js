...
(function($) {
	...
	var setPageBar=function (tableId, data){
		...
		if(memoryReqData[tableId]["skipShow"]){
			...
			pageBarStr	 +=						'<input id="skipNumInput" onkeypress="return /[\\\d]/.test(String.fromCharCode(event.keyCode));" type="text" maxlength="4" style="width: 40px;padding-top: 0px;padding-bottom: 0px;margin-top: 0px;margin-bottom: 0px;">页';
